	...
	<section class="txl-main">
		<div class="swiper-container" id="banner-img">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<a href="#"><img src="//static.tfeie.com/v2/images/aimg.jpg" width="100%"></a>
				</div>
				<div class="swiper-slide">
					<a href="#"><img src="//static.tfeie.com/v2/images/aimg.jpg" width="100%"></a>
				</div>
		...
		<div id="bd">
			...
			<div class="bd">
				...
				<div class="bg-eeeeee pad-0-10 line-40 fs-16" id="c">C</div>
				<div class="tj-main box-s pad-0-10">
					<div class="itms clearfix">
						<div class="img">
							<img src="//static.tfeie.com/v2/images/tx.png" width="40" height="40">
				...
				<div class="bg-eeeeee pad-0-10 line-40 fs-16" id="d">D</div>
				<div class="tj-main box-s pad-0-10">
					<div class="itms clearfix">
						<div class="img">
							<img src="//static.tfeie.com/v2/images/tx.png" width="40" height="40">
