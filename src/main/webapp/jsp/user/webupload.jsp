...
<title>WEB图片上传组件</title>
<script type="text/javascript"
	src="//static.tfeie.com/js/jquery-1.11.1.min.js"></script>
<script type="text/javascript"
	src="//static.tfeie.com/js/jquery.weui.js"></script>
<script
	src="//static.tfeie.com/js/webuploader/webuploader.min.js"></script>
<link rel="stylesheet" type="text/css"
	href="//static.tfeie.com/css/weui.min.css">
<link rel="stylesheet" type="text/css"
	href="//static.tfeie.com/js/webuploader/webuploader.css">
<link rel="stylesheet" type="text/css"
	href="//static.tfeie.com/js/webuploader/style.css">
<link rel="stylesheet" type="text/css"
	href="//static.tfeie.com/js/webuploader/webupload.css">
<style type="text/css">
.savePicBtn {
    background: #ffffff;
		...
		<div id="uploader" class="wu-example">
			...
			<div class="statusBar" style="display: none;">
				...
				<div class="btns">
					...
					<div class="savePicBtn" id="savePicBtn">Save to</div>
				</div>
			</div>
		</div>
